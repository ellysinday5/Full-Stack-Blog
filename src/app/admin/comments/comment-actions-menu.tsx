			...
			>
				<div className="px-6 py-5 space-y-4">
					<div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-white/50">
						...
						<span>
							<span className="font-semibold text-white/80">Post:</span>{" "}
							{postTitle}
						</span>
					</div>
				...
				<div className="flex items-center justify-between gap-3 px-6 pb-6">
					...
					<button
						...
						className="flex items-center gap-1.5 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm font-semibold text-red-400 hover:bg-red-500/20 transition-colors"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							className="h-4 w-4"
					...
					<div className="flex items-center gap-2">
						{approved ? (
							<span className="rounded-md border border-green-500/20 bg-green-500/8 px-2.5 py-1 text-[11px] font-medium text-green-400/80">
								Already Posted
							</span>
						) : (
							<button
								...
								className="rounded-lg bg-[#1a2e1a] px-4 py-2 text-sm font-semibold text-white hover:bg-[#253e25] transition-colors"
							>
								Post Comment
							</button>
						)}
