	...
	return (
		<div className="mt-16 rounded-2xl sm:rounded-3xl border border-[#dcefe3] bg-white p-5 sm:p-8 md:p-12 shadow-sm">
			...
			<div className="flex flex-wrap items-center justify-between gap-4 mb-2">
				<h3 className="text-xl sm:text-2xl font-bold text-[#0f3d2e] font-serif">
					Leave a Reply
				</h3>

				{/* Anonymous toggle */}
				<label className="inline-flex items-center cursor-pointer gap-3 group">
					<span className="text-sm font-semibold text-[#4c6f5e] group-hover:text-[#0f3d2e] transition-colors">
						Anonymous
					</span>
			...
			<form ref={formRef} action={formAction} className="space-y-8">
				...
				<div className="flex items-center gap-3">
					...
					<label
						htmlFor="saveInfo"
						className="text-sm font-medium text-[#4c6f5e] cursor-pointer hover:text-[#0f3d2e] transition-colors"
					>
