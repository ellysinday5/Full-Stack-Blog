			...
			<div className="px-6 py-6 text-center">
				...
				<div className="flex items-center justify-center gap-3">
					...
					<button
						...
						onClick={onConfirm}
						disabled={loading}
						className={`flex items-center justify-center gap-1.5 rounded-lg border px-5 py-2 text-sm font-semibold disabled:opacity-50 transition-colors ${styles.confirm}`}
					>
						{variant === "danger" && (
							<svg
								xmlns="http://www.w3.org/2000/svg"
